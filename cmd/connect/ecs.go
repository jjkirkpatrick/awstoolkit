...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println(aurora.Bold(aurora.BrightGreen("ECS Connect. Running with Profile ")), aurora.BrightCyan(c.Profile), aurora.BrightGreen("and Region "), aurora.BrightCyan(c.Region))
		ecsConnect(c)
	},
}
